...
# Function to get or calculate recommendations
def get_recommendations(selected_user, selected_city, session_state):
    if "recommendations" not in session_state:
        st.session_state.recommendations = {}
    if selected_user in st.session_state.recommendations:
        return st.session_state.recommendations[selected_user]

    similar_users_df, suggestions = main_recommender(selected_user, selected_city)
    recommendations = process_output(similar_users_df, suggestions, selected_city, yelp_POI, TM_events, foursq_POI)

    st.session_state.recommendations[selected_user] = recommendations
