...
def load_users():
    POI_user=pd.read_csv(r"Data\After EDA\POI_Ratings.csv")
    TM_user=pd.read_csv(r"Data\After EDA\Venue_Reviews.csv")
...
# Pre=processing 
    ...
    yelp_POI=pd.read_csv(r"Data\After EDA\Yelp_Data_1EDA.csv")
    TM_events=pd.read_csv(r'Data\After EDA\TM_data_EDA.csv')
    foursq_POI=pd.read_csv(r"Data\After EDA\FourSq_data_EDA.csv")
