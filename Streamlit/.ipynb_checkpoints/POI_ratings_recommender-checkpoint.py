...
def load_users():
    POI_user=pd.read_csv(r"C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA\POI_Ratings.csv")
    TM_user=pd.read_csv(r"C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA\Venue_Reviews.csv")
...
def main_recommender( user_name,user_city ):
    ...
    venue_ratings=pd.read_csv(r'C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA\Venue_Reviews.csv')
    venue_ratings.rename(columns={'Event_type': 'Category'}, inplace=True)
    # import data for the recommender
    POI_ratings=pd.read_csv(r'C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA\POI_Ratings.csv')
...
def process_output(similar_users_df, suggestions,user_city):
# Pre=processing 
    # import all required csv's for output
    yelp_POI=pd.read_csv(r"C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA/Yelp_Data_1EDA.csv")
    TM_events=pd.read_csv(r'C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA/TM_data_EDA.csv')
    foursq_POI=pd.read_csv(r'C:\Users\shrut\Documents\light house labs\PROJECTS\Final Project\Whats-Next-to-do---Recomender-system\Data\After EDA/TM_data_EDA.csv')
