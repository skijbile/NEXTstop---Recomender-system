...
from POI_ratings_recommender import main_recommender,process_output,load_users,pre_process,print_recommendations # this .py file has the logic for the recommendations
