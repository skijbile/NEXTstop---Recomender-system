...
# Check if recommendations are available in the cache
    ...
    if selected_user in st.session_state.recommendations and selected_city in st.session_state.recommendations[selected_user]:
        recommendations = st.session_state.recommendations[selected_user][selected_city]
    else:
        recommendations = generate_recommendations(selected_user, selected_city, Events, suggested_events, restaurants, suggested_restaurant, POI, suggested_POI)
        if selected_user not in st.session_state.recommendations:
            st.session_state.recommendations[selected_user] = {}
        st.session_state.recommendations[selected_user][selected_city] = recommendations
